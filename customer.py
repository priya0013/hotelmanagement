...
#cus
        ...
        combo_Nationality["value"]=("India","American","British")
        combo_Nationality.current(0)
        combo_Nationality.grid(row=7,column=1)

        lblProof=Label(labelframeleft,font=("arial",12,"bold"),text=" Id Proof Type:",padx=2,pady=6)
        ...
        combo_Proof["value"]=("Aadhaar ID","Drivinglicence","Passport")
    ...
    def add_data(self):
        if self.var_mobile.get()=="" or self.var_mother.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Success","custom hae been added",parent=self.root)
