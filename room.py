...
class RoomBooking:
    def __init__(self,root):
        ...
        lbl_title=Label(self.root,text="ROOMBOOKING DETAILS",font=("times new roman",40,"bold"),bg="black",fg="white",bd=4,relief=RIDGE)
        lbl_title.place(x=0,y=0,width=1290,height=50)

        img2=Image.open(r"C:\Users\ragha\Desktop\HOTEL MANAGEMENT SYSTEM\images\logo1.jpg")
        ...
        # Total Cost
        lblIdNumber=Label(labelframeleft,font=("arial",12,"bold"),text="Sub Total:",padx=2,pady=6)
        ...
        #Right side
        img3=Image.open(r"C:\Users\ragha\Desktop\HOTEL MANAGEMENT SYSTEM\images\logo1.jpg")
    ...
    def add_data(self):
        if self.var_contact.get()=="" or self.var_checkin.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="priya33699",database="management")
